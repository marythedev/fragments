...
async function deleteFragment(ownerId, id) {
  // Create the DELETE API params from our details for S3 and DynamoDB
  const S3Params = {
    Bucket: process.env.AWS_S3_BUCKET_NAME,
    Key: `${ownerId}/${id}`,
  };
  ...
  try {
    // Use our client to send the S3 command
